...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "fixed inset-0 top-[81px] z-40 bg-black/40 backdrop-blur-xs transition-opacity duration-300 md:hidden",
      ...
      <div
        className={cn(
          "fixed top-[81px] right-0 bottom-0 z-50 w-full max-w-[300px] bg-white border-l border-slate-200 p-6 flex flex-col gap-6 shadow-2xl transition-transform duration-300 ease-in-out md:hidden",
